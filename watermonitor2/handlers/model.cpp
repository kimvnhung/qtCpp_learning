...
QVariant WaterModel::data(const QModelIndex& index, int role) const
{
  ...
  if (role == Qt::TextAlignmentRole) {
    ...
    switch (index.column()) {
      ...
      case 1: return QVariant(q.getLocation().c_str());
      case 2: return QVariant(q.getTime().c_str());
      case 3: return QVariant(q.getDeterminand().c_str());
      case 4: return QVariant(q.getResult());
      case 5: return QVariant(q.getUnit().c_str());
      case 6: return QVariant(q.getWaterType().c_str());
      case 7: return QVariant(q.getLat());
      case 8: return QVariant(q.getLong());
    }
  }
...
QVariant WaterModel::headerData(int section, Qt::Orientation orientation, int role) const
{
  ...
  switch (section) {
    ...
    case 3: return QString("Determinand");
    case 4: return QString("Result");
    case 5: return QString("Unit");
    case 6: return QString("Water Type");
    case 7: return QString("Latitude");
    case 8: return QString("Longitude");
    default: return QVariant();
  }
}


void WaterModel::updateData(std::vector<Water> data)
{
  LOG();
  beginResetModel();
  m_data = data;
