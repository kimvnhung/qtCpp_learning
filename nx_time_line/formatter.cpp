...
{
    return Format::duration_formats_begin <= format
           && format < Format::duration_formats_end;
}


//--------------------------------------------------------------------------------------------------

using FormatsHash = QHash<Format, QString>;
using Formatter = Formatter;
using FormatterPtr = FormatterPtr;
...
{
    Q_ASSERT(!isDurationFormat(format));
