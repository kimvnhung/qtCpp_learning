...
import "math_utils.js" as MathUtils
...
Item
{
    ...
    property color color: "#68FFBE"/*ColorTheme.colors.dark13*/
    property color textColor: "#62A1FF" /*ColorTheme.colors.brand_contrast*/

    property string text
    property font font

    property color shadowColor: "#8068FFBE"/*ColorTheme.transparent(ColorTheme.colors.dark1, 0.5)*/
