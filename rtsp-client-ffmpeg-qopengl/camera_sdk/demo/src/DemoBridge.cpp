...
DemoBridge::DemoBridge(QObject* parent)
    : QObject(parent)
...
void DemoBridge::start(const QString& url)
{
...
void DemoBridge::addVideoItem(QObject* item)
{
    if (!item) { return; }
