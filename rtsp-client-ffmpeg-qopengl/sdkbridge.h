...
class SdkDemoBridge : public QObject {
    Q_OBJECT
...
public:
    explicit SdkDemoBridge(QObject* parent = nullptr);
    ~SdkDemoBridge() override;

    Q_INVOKABLE void start(const QString& url);
    Q_INVOKABLE void stop();
    Q_INVOKABLE void reconnect();

    // Register SDK VideoItem instances for frame presentation
