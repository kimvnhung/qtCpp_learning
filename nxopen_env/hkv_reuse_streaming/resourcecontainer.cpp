...
void ResourceContainer::advance(int step)
{
    if (!step)
        return;
...
QRectF ResourceContainer::boundingRect() const
{
    qreal adjust = 0.5;
...
void ResourceContainer::paint(QPainter *painter, const QStyleOptionGraphicsItem *, QWidget *)
{
    // Body
...
QPainterPath ResourceContainer::shape() const
{
    QPainterPath path;
