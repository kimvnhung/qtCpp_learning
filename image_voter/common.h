...
#define LAST_EXPORT_PATH_KEY "last_export_path"
...
#define GET_LAST_EXPORT_PATH() GETS(LAST_EXPORT_PATH_KEY, "").toString()
#define SET_LAST_EXPORT_PATH(VALUE) SETS(LAST_EXPORT_PATH_KEY, VALUE)
