...
EnvironmentalLitterIndicatorsPage::EnvironmentalLitterIndicatorsPage(QWidget* parent, QStackedWidget* pageStack)
    : QWidget(parent) {
    ...
    customFilters = new CreateFilters(filterPanel);
